...
async function updateMenemen() {
  // Use the direct Wikimedia Commons image link rather than the Wikipedia viewer page
  const targetUrl = 'https://upload.wikimedia.org/wikipedia/commons/e/e0/My_breakfast_menemen.jpg';
